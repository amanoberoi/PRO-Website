...
<div align="center">
	...
	$db = "student";
	 ...
	 $query="SELECT * FROM attendance";
		...
		<tr>
		<td><b>Name</b></td> <td><b>am1</b></td> <td><b>ap1</b></td> <td><b>ac1</b></td> <td><b>em</b></td> <td><b>bee</b></td> <td><b>am2</b></td> <td><b>ap2</b></td> <td><b>ac2</b></td> <td><b>ed</b></td> <td><b>spa</b></td> <td><b>Action</b></td> </tr> ";
while($result=mysql_fetch_array($resource))
	{ 
	echo "<tr><td>".$result[1]."</td><td>".$result[2]."</td><td>".$result[3]."</td><td>".$result[4]."</td><td>".$result[5]."</td><td>".$result[6]."</td><td>".$result[7]."</td><td>".$result[8]."</td><td>".$result[9]."</td><td>".$result[10]."</td><td>".$result[11]."</td><td>
	<a href=\"modifya2.php?id=".$result[0]."\"><img border=\"0\" src=\"uploads/1/3/9/3/13935928/modify.jpg\" onmouseover=\"this.src='uploads/1/3/9/3/13935928/modifymouseover.jpg';\" onmouseout=\"this.src='uploads/1/3/9/3/13935928/modify.jpg';\" /></a>
	</td></tr>";
	} echo "</table>";
	 ?>
      </div>
