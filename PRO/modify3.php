...
<table align="center" cellpadding="0" bgcolor="#FFFFFF" width="800" border="0">
  <p align="center">
    <?php 
	 ...
	 $query="UPDATE students SET fname='".$fname."', lname='".$lname."', address='".$address."', phoneno='".$phoneno."', mobileno='".$mobileno."', gender='".$gender."', semester='".$semester."', password='".$password."' WHERE rollno='".$rollno."'";
