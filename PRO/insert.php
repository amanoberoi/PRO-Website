...
<tr>
            <td width="129"><strong>Last name of Student:</strong></td>
            <td width="152"><label>
          ...
          <tr>
            ...
            <td><input type="text" name="phoneno" id="textfield4" /></td>
          </tr>
<tr>
            <td><strong>Mobile No.</strong>:</td>
            <td><input type="text" name="mobileno" id="textfield4" /></td>
          </tr>
<tr>
            <td><strong>Gender</strong>:</td>
            <td><input type="text" name="gender" id="textfield4" /></td>
          </tr>
<tr>
            <td><strong>Semester</strong>:</td>
            <td><input type="text" name="semester" id="textfield4" /></td>
          </tr>
<tr>
            <td><strong>Password</strong>:</td>
            <td><input type="text" name="password" id="textfield4" /></td>
          </tr>
        </table>
		<br></br>
        <p align="center">
