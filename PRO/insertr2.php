...
<p align="center">
	...
	$link=mysql_connect("localhost","root","") or die("Cannot Connect to the database!");
	 ...
	 $rquery="SELECT rollno FROM students WHERE rollno = '$rollno'";
	 $rs = mysql_query($rquery, $link);
		if (mysql_num_rows($rs)==1)
		{
		echo "The entered username already exists. Please enter a new one.";
		header("location:insertr.php");
		}
		else
		{

			$query="INSERT INTO result (rollno, name, m1, p1, c1, em, bee, m2, p2, c2, ed, spa) VALUES('".$rollno."', '".$fname."', '".$am1."', '".$ap1."', '".$ac1."', '".$em."', '".$bee."', '".$am2."', '".$ap2."', '".$ac2."', '".$ed."', '".$spa."')";
		 
		  if(!mysql_query($query,$link))
		  {die ("An unexpected error occured while saving the result, Please try again!");}
		  else
		 {
