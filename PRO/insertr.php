...
<div align="center">
<form id="form1" name="form1" method="get" action="insertr2.php">
...
<tr>
            <td width="129"><strong>First name of Student:</strong></td>
            <td width="152"><label>
              <input type="text" name="fname" id="textfield" />
            </label></td>
</tr>
<tr>
            <td width="129"><strong>AM I</strong></td>
            <td width="152"><label>
              <input type="text" name="am1" id="textfield" />
            </label></td>
</tr>
          <tr>
            <td><strong>AP I</strong></td>
            <td><input type="text" name="ap1" id="textfield3" /></td>
          </tr>
          <tr>
            <td><strong>AC I</strong></td>
            <td><input type="text" name="ac1" id="textfield3" /></td>
          </tr>
		  <tr>
            <td><strong>EM</strong></td>
            <td><input type="text" name="em" id="textfield3" /></td>
          </tr>
		  <tr>
            <td><strong>BEE</strong></td>
            <td><input type="text" name="bee" id="textfield3" /></td>
          </tr>
		  <tr>
            <td><strong>AM II</strong></td>
            <td><input type="text" name="am2" id="textfield3" /></td>
          </tr>
		  <tr>
            <td><strong>AP II</strong></td>
            <td><input type="text" name="ap2" id="textfield3" /></td>
          </tr>
		  <tr>
            <td><strong>AC II</strong></td>
            <td><input type="text" name="ac2" id="textfield3" /></td>
          </tr>
		  <tr>
            <td><strong>ED</strong></td>
            <td><input type="text" name="ed" id="textfield3" /></td>
          </tr>
		  <tr>
            <td><strong>SPA</strong></td>
            <td><input type="text" name="spa" id="textfield3" /></td>
          </tr>
