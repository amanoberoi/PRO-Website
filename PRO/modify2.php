...
<div align="center">
    <?php 
	 ...
	 $query="SELECT * FROM students WHERE rollno='".$id."'";
     ...
     <form id="form1" name="form1" method="get" action="modify3.php">
        <table align="center" width="291" border="0">
          ...
          <tr>
            ...
            <td><input type="text" name="lname" id="textfield2" value="<?php echo $result[2] ?>" /></td>
          </tr>
          <tr>
            <td><strong>Address :</strong></td>
            <td><input type="text" name="address" id="textfield3" value="<?php echo $result[3] ?>" /></td>
          </tr>
		  <tr>
            <td><strong>Phone No. :</strong>:</td>
            <td><input type="text" name="phoneno" id="textfield4" value="<?php echo $result[4] ?>" /></td>
          </tr>
		  <tr>
            <td><strong>Mobile No. :</strong>:</td>
            <td><input type="text" name="mobileno" id="textfield5" value="<?php echo $result[5] ?>" /></td>
          </tr>
		  <tr>
            <td><strong>Gender :</strong>:</td>
            <td><input type="text" name="gender" id="textfield6" value="<?php echo $result[6] ?>" /></td>
          </tr>
		  <tr>
            <td><strong>Semester :</strong>:</td>
            <td><input type="text" name="semester" id="textfield7" value="<?php echo $result[7] ?>" /></td>
          </tr>
		  <tr>
            <td><strong>Password :</strong>:</td>
            <td><input type="text" name="password" id="textfield8" value="<?php echo $result[8] ?>" /></td>
          </tr>
        </table>
		<br></br>
        <p align="center">
